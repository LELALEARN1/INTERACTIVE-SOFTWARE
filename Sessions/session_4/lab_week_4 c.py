...
#Exercise 3: Testing the Functionality             # 4 NOT WORKING 
class TaskList:
    def __init__(self, owner):
        self.owner = owner.upper()
        self.tasks = []
...
#%%
# TUESDAY 240226 
# Exercise 3: Test Functionality (again)                   # 5 WORKING
...
#%%
#Exercise 4: COMPOSITION                                       # 6 WORKING IN GC
# # TUESDAY 240226 
class Task:
...
class TaskList:
    ...
    def __str__(self):                             # this line needs to be indented as part of the 'Task' class & not the 'TaskList' class
...
#%%
#Exercise 5: Developing the Task                  # 7 NOT WORKING IN GC
